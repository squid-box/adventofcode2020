	...
	public class Program
	{
        ...
        private static bool CreateDailyProblemCodeFiles(string pathToProblemFile, string pathToProblemTestFile)
        {
            ...
            try
            {
                ...
                File.WriteAllText(Path.Combine(pathToProblemFile), string.Format("namespace AdventOfCode2020.Problems{0}{{{0}    /// <summary>{0}    /// Solution for <a href=\"https://adventofcode.com/2020/day/{1}\">Day {1}</a>.{0}    /// </summary>{0}    public class Problem{1} : ProblemBase{0}    {{{0}        public Problem{1}() : base({1}) {{ }}{0}{0}        /// <inheritdoc />{0}        protected override string SolvePartOne(){0}        {{{0}            return \"Unsolved\";{0}        }}{0}{0}        /// <inheritdoc />{0}        protected override string SolvePartTwo(){0}        {{{0}            return \"Unsolved\";{0}        }}{0}    }}{0}}}{0}", Environment.NewLine, Day));
